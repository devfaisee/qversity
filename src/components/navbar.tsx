...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-white bg-opacity-40 backdrop-birghtness-100 bg-slate-100 backdrop-blur-md shadow-md p-4 rounded-b-lg border-b border-gray-200 z-50 h-auto lg:h-20">
