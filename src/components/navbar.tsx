...
const Navbar = () => {
  ...
  return (
   <nav className="fixed top-0 left-0 w-full bg-transparent backdrop-blur-md shadow-xl p-4 rounded-b-lg border-b border-white/50 z-50 h-auto lg:h-20 text-white-900 animate-fade-in">
