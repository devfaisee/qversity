...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-white bg-opacity-70 backdrop-blur-lg shadow-lg p-4 rounded-b-lg border-b border-white/50 z-50 h-auto lg:h-20"">
